...
struct goodix_ts_coords {
	int id;
	unsigned int x, y, w, p, overlapping_area;
};
...
struct goodix_ts_core {
	...
	int double_wakeup;
	int gesture_enabled;
	volatile unsigned long touch_id;
...
#undef CONFIG_GOODIX_DEBUG /* We never know */
/* log macro */
